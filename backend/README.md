...
## Project Structure
    ...
    ├── helicopter_simulati_34461  # Django project configurations
...
1. Clone this repo and `cd helicopter_simulati_34461`
...
2. Clone this repo and `cd helicopter_simulati_34461`
